...
SCENE_COUNT = 4
LINES_PER_SCENE = "4〜6"   # 1シーンのセリフ行数。2〜3行だと1往復で終わる
...
**1行は20字以内**と短くし、行数で往復を作ります（長い行を並べるのではなく、
短い行を速く往復させるのがこのジャンルのテンポです）。説明的な行を入れない。"""
...
- **各シーンの dialogue は{LINES_PER_SCENE}行**。1行は35字以内の話し言葉。
